...
using namespace std;
/// 串口接收缓冲区
extern BufferQueue* g_edge_recv_queue;
/// 串口发送缓冲区
extern BufferQueue* g_com_send_queue;

/// 云端发送缓冲区
extern BufferQueue* g_cloud_send_queue;
extern std::atomic<bool> is_wireless;
/// bootstrap.servers
extern std::string brokers;
extern std::string local_brokers;
